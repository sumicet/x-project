...
export const fundraisers: Fundraiser[] = [
    {
        ...
        socialMedia: [{ name: 'Twitter', url: 'https://twitter.com/beeple' }],
        funds: {
            collected: '9512310',
            goal: '20000000',
            currencies: [
                { name: 'ETH', amount: '348' },
                { name: 'MATIC', amount: '453,119' },
                { name: 'USDT', amount: '400,100' },
            ],
            currenciesCount: '4',
        },
    ...
    },
    {
        ...
        funds: {
            ...
            currencies: [
                { name: 'ETH', amount: '2' },
                { name: 'MATIC', amount: '1214' },
                { name: 'USDT', amount: '2100' },
            ],
            currenciesCount: '4',
        },
