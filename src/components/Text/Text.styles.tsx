...
export const Text = styled.p<TextProps>`
    color: ${props => (props.color && props.theme.color[props.color]) || props.theme.color.text1};
    font-size: ${props =>
...
export const Paragraph = styled(Text)<Props>`
    color: ${props => (props.color && props.theme.color[props.color]) || props.theme.color.text2};
...
export const ParagraphSmall = styled(Text)<Props>`
    color: ${props => (props.color && props.theme.color[props.color]) || props.theme.color.text3};
